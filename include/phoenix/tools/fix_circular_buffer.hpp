...
private:
    ...
    static constexpr std::size_t BUFFER_CAPACITY{131072u};
    static constexpr std::size_t BUFFER_WRAP_BOUNDARY{32768u}; // assuming we never get more than this per socket read
